...
import { getUserRole, getUserName, getUserEmail, getUserUsername } from "@/shared/api-client";
import { hasMinRole, type Role } from "@/shared/hooks/use-role-guard";
import { useDeploymentConfig } from "@/shared/hooks/use-deployment-config";
import { registryNav, reviewNav, userNav, adminNav, type NavItem } from "./nav-items";
