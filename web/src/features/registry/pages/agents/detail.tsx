...
import { useWhoami } from "@/features/admin/hooks";
import { useAgentDownloads, useFeedbackSummary } from "@/features/registry/hooks-agents";
import { useFeedback } from "@/features/insights/hooks";
import { useRegistryItem, useAgentVersions, useAgentVersionDetail } from "@/features/registry/hooks-queries";
import { getUserRole } from "@/shared/api-client";
import { registry } from "@/features/registry/api";
import { hasMinRole } from "@/shared/hooks/use-role-guard";
import type { FeedbackItem } from "@/features/registry/types";
import { PullCommand } from "@/features/registry/pull-command";
import { VersionDropdown } from "@/features/registry/version-dropdown";
import { StatusBadge } from "@/features/registry/status-badge";
import { IdeBadges } from "@/features/registry/ide-badges";
import { FEATURE_LABELS, type IdeFeature } from "@/shared/lib/ide-features";
import { ReviewForm } from "@/features/registry/review-form";
...
import { AgentEditForm, type AgentEditFormProps } from "@/features/registry/agent-edit-form";
import { CoAuthorInput, type CoAuthor } from "@/features/registry/co-author-input";
import { compactNumber, copyToClipboard } from "@/shared/lib/utils";
