...
import { getUserName, getUserEmail, getUserRole, getUserUsername, getUserAvatar, setUserUsername } from "@/shared/api-client";
import { ROLE_LABELS, type Role } from "@/shared/hooks/use-role-guard";
...
import { AvatarEditable } from "@/features/auth/avatar-upload";
