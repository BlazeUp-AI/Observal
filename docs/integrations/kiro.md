...
| Superpowers | Installed through the generated Kiro agent JSON |
...
| Rules | Stored in the generated Kiro agent prompt |
| Steering files | Agent resources include `AGENTS.md`, `README.md`, and Kiro skills |
